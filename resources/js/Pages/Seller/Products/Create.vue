        ...
        <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                    <h1 class="text-2xl font-bold text-gray-800">Form Produk Baru</h1>
                    <p class="text-sm text-gray-500 mt-1">Lengkapi data produk agar lebih mudah dibeli pelanggan.</p>
                </div>
                ...
                <form @submit.prevent="submit" class="p-6 sm:p-8 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Foto Gallery</label>
                            <input
                                type="file"
                                multiple
                                accept="image/*"
